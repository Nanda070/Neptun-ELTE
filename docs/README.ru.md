...
| Карта кампуса (фаза A 0–6 готова; Flutter фаза B отложена) | План [`CAMPUS_MAP_PLAN.ru.md`](Technical/CAMPUS_MAP_PLAN.ru.md) · [EN](Technical/CAMPUS_MAP_PLAN.md) · пакет [`campus_map_package/`](Technical/campus_map_package/) ([QA](Technical/campus_map_package/QA_REPORT.md)) · research [`campus_map_research/`](Technical/campus_map_research/README.md). Разрешение на JPG basemap **pending** (не бандлить в APK/App Store). В приложении по-прежнему только внешние Maps. |
