...
| Карта кампуса (**WIP** / BIS FootPrint **1.8.3** / только IK) | План [`CAMPUS_MAP_PLAN.ru.md`](Technical/CAMPUS_MAP_PLAN.ru.md) · [EN](Technical/CAMPUS_MAP_PLAN.md) · пакет [`campus_map_package/`](Technical/campus_map_package/) · полигоны [`campus_map_research/bis/polygons/`](Technical/campus_map_research/bis/polygons/README.md). Всё ещё в разработке — не готовый BIS 1:1. Отгружено: FootPrint + светлая палитра + hull; приблизительный A→B; **2573/3112**; IK LD+LE. |
