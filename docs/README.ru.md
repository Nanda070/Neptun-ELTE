...
| План карты кампуса (сначала карта) | [`CAMPUS_MAP_PLAN.ru.md`](Technical/CAMPUS_MAP_PLAN.ru.md) · [EN](Technical/CAMPUS_MAP_PLAN.md) · research [`campus_map_research/`](Technical/campus_map_research/README.md) |
