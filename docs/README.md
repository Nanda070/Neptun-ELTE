...
| Campus map (**BIS WebView 1.9.0**) | Plan [`CAMPUS_MAP_PLAN.md`](Technical/CAMPUS_MAP_PLAN.md) · [RU](Technical/CAMPUS_MAP_PLAN.ru.md). Primary: official `bis.elte.hu` WebView + ELTE IIG / Caesar login (secure-storage save). Offline FootPrint package [`campus_map_package/`](Technical/campus_map_package/) / research — debug secondary. |
