...
| **Version** | **1.3.1** (marketing) — scheme `1.<feature-line>.<patch>`; line **3** = plan items 1–3; patch **1** = auth/2FA/Student-web-full fixes; next big block → **1.4.0**; final product → **2.0.0**. Settings shows three numbers only (no `+build`). ([full policy](Technical/TECHNICAL.md#versioning)) |
