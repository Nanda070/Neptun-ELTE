...
|                      |                                                                                                                                                                                                                                |
| -------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Статус**           | Foundation **1a / 1b / 1c / 1 / 2 / 3** + почта п. **4** + ghost п. **5** + платежи п. **7** + карты п. **8** + «Что изменилось» п. **9** + студенческий п. **12** + app shortcuts п. **13 сделан** (сен 2026). Пункты **6, 10–11**, **14** ещё в бэклоге                                                                                                                                                   || **Релиз**            | Текущая маркетинговая версия **1.3.4** (`pubspec` **1.3.4+1**). Feature-line **3** = пункты плана **1–3**; патч **4** = поиск почты + фильтр непрочитанных (п. **4**). **1.3.3** = фикс мгновенного «сессия истекла» после 2FA. Следующий крупный блок → **1.4.0**; финал → **2.0.0**. Для пользователя / Settings / docs — только три числа, без рекламы `+build`. См. [TECHNICAL § Версионирование](TECHNICAL.ru.md#версионирование). |
