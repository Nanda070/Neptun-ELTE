...
|                      |                                                                                                                                                                                                                                |
| -------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Статус**           | Foundation **1a / 1b / 1c / 1 / 2 / 3** + почта п. **4** + студенческий п. **12 сделан** (сен 2026). Пункты **5–11, 13–14** ещё в бэклоге                                                                                                                                                   |
...
| 12  | Студенческий                                                      | **DONE** (сент. 2026). Заявка / банк / профиль **HAR-поля**; QR / номер / срок **по-прежнему нет** (честно — не выдумываем) |
