...
- **Принудительный logout сессии** при провале refresh / silent re-auth — **в коде** (`SessionGuard.forceExpiredLogout`); логин + учебный кэш сохраняются (**1**). **1a** / **1b** / **1** / **2** / **3** / **4** / **12** сделаны; дальше бэклог с п. **5** (и оставшиеся **6–11, 13–14**).
