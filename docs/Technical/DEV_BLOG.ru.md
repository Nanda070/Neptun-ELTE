...
- **Принудительный logout сессии** при провале refresh / silent re-auth — **в коде** (`SessionGuard.forceExpiredLogout`); логин + учебный кэш сохраняются (**1**). **1a** / **1b** / **1** / **2** / **3** / **4** / **7** / **8** / **13** сделаны; дальше бэклог с п. **5** (параллельно: **5–6, 9–12**, **14**).
