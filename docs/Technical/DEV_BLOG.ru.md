...
- **Принудительный logout сессии** при провале refresh / silent re-auth — **в коде** (`SessionGuard.forceExpiredLogout`); логин + учебный кэш сохраняются (**1**). **1a** / **1b** / **1** / **2** / **3** / **4** / **5** / **7** / **8** / **12** / **13** сделаны; дальше бэклог с п. **6** (параллельно: **6, 9–11**, **14**).
