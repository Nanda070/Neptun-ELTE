...
| **1.5.11** | Patch — campus map **Phase A (0–6)** docs/data complete (MVP package + QA **41 pass / 0 fail / 2 waive**); honesty sync (no in-app indoor A→B yet at that ship; Phase B Flutter came later). App binary same product line as **1.5.10** session reliability + ship tag for device/GitHub. Tag **v1.5.11**. |
