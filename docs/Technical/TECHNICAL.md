...
Indoor campus map (LD/LE A→B): **map data first** — [CAMPUS_MAP_PLAN.md](CAMPUS_MAP_PLAN.md) / [RU](CAMPUS_MAP_PLAN.ru.md); Flutter UI deferred until the graph package is finished. Research: [`campus_map_research/`](campus_map_research/README.md).  
