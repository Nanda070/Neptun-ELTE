...
| Indoor-карта кампуса | **Research + схема** | Дамп + схема фазы 1 в `campus_map_research/schema/`; [CAMPUS_MAP_PLAN](CAMPUS_MAP_PLAN.ru.md) фазы 0–1 готовы, далее фаза 2 (оцифровка LD); Flutter UI отложен (фаза B). В приложении по-прежнему только внешний maps deep-link |
...
| `docs/Technical/CAMPUS_MAP_PLAN.md` / `.ru.md` | Indoor-карта кампуса — **сначала карта** (фазы 0–1 готовы: схема; далее фаза 2 оцифровка LD; фаза B Flutter отложена); research + схема в `campus_map_research/` |
